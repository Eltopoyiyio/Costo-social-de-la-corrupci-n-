...
tabla_subareas <- tibble::tribble(
  ...
  "Salud",      "salud",     "Salud mental ambulatoria (COSAM)",               "cosam",             1304.0,              "centros construidos",           "Dato estimado",              NA,           NA,
  ...
  # Educación
  "Educación",  "educacion", "I+D y matriz productiva",                        "id",                40.0,                "empleos cualificados en I+D (subsidio Corfo)",   "Escenario proyectado",   NA,           NA,
  "Educación",  "educacion", "Becas universitarias",                           "becas",             1.15,                "becas universitarias anuales",  "Dato estimado",              NA,           NA,
  ...
  "Pensiones",  "pensiones", "Deuda previsional de empleadores",               "deuda_prev",        16000000.0,          "deuda total de empleadores (referencia)","Escenario proyectado", NA,          NA,
  ...
  "Pensiones",  "pensiones", "Jóvenes sin cotización futura",                  "jovenes_cot",       0.6,                 "jóvenes con un año de cotización garantizada","Escenario proyectado",    NA,  NA,
  ...
  "Seguridad",  "seguridad", "Ciberdelito y delitos económicos (PDI)",         "pdi",               30.0,                "investigadores especializados por un año","Dato estimado",      NA,           NA,
  ...
  "Seguridad",  "seguridad", "Centros de reinserción",                         "reinsercion",       5.25,                "personas en reinserción por un año","Escenario proyectado",    NA,           NA,
  "Seguridad",  "seguridad", "Fiscales especializados (ECOH)",                 "ecoh",              12197.0,             "presupuesto ECOH (referencia)", "Dato estimado",              NA,           NA,
  ...
  "Vivienda",   "vivienda",  "Lista de espera SERVIU",                         "lista_espera",      600800.0,            "programa DS49 anual (referencia)","Escenario proyectado",     NA,           NA,
  "Vivienda",   "vivienda",  "Subsidios de arriendo (DS52)",                   "ds52",              6.712,               "familias con subsidio 8 años",  "Dato estimado",              NA,           NA,
  ...
  "Género",     "genero",    "Pensiones alimenticias",                         "alimentos",         30.0,                "funcionarios en Tribunales de Familia por un año","Dato estimado", NA,        NA,
  ...
  "Género",     "genero",    "Acceso a la justicia VIF",                       "justicia_vif",      30.0,                "profesionales especializados VIF por un año","Dato estimado",  NA,           NA,
...
contextos_subarea <- list(
  ...
  id = "Chile lleva más de diez años invirtiendo menos del 0,4% de su PIB en investigación y desarrollo —una de las cifras más bajas de la OCDE, cuyo promedio supera el 2,7%. Esa subinversión tiene una consecuencia directa: una economía que no invierte en I+D no genera los empleos cualificados que sus propios técnicos e ingenieros necesitan para quedarse. El programa Capital Humano para la Innovación de Corfo financia la contratación de profesionales y técnicos en empresas que buscan desarrollar proyectos de innovación: entrega hasta $40 millones por proyecto para incorporar ese talento. Entre 2023 y 2024 financió 72 proyectos con $2.800 millones en total. Chile tiene apenas 1,1 investigadores por cada 1.000 personas laboralmente activas. El promedio OCDE es más del doble.",
  ...
  alimentos = "En Chile hay 238.724 personas registradas como deudoras de pensiones alimenticias —el 96% son hombres. El dinero que los tribunales ya ordenaron pagar y que sigue sin transferirse suma $2,5 billones. Detrás de esa cifra hay mujeres —en su gran mayoría madres— que asumen solas el costo económico de criar a sus hijos mientras el Estado no tiene la capacidad de cobrar lo que la justicia ya resolvió. La brecha no es legal: es institucional. En 2024, el gobierno destinó $11.000 millones para contratar más funcionarios en Tribunales de Familia. Sostener a un funcionario especializado en esta materia cuesta aproximadamente $30.000.000 al año.",
...
impactos_texto <- list(
  ...
  id = list(
    inverlink = "Los $200.940 millones sustraídos de CORFO habrían financiado 5.024 empleos cualificados en I+D a través del programa Capital Humano para la Innovación de Corfo —investigadores, ingenieros y especialistas en desarrollo tecnológico contratados por empresas chilenas para crear los sectores que la economía aún no tiene. Para dimensionarlo: entre 2023 y 2024, ese programa financió 72 proyectos en todo el país con $2.800 millones. El monto del Caso Inverlink habría podido financiar ese esfuerzo completo 71 veces.",
    pacogate  = "Los $41.898 millones malversados en Carabineros habrían financiado 1.047 empleos cualificados en I+D a través del programa Capital Humano para la Innovación de Corfo. Son más de mil puestos de trabajo para ingenieros en energías renovables, especialistas en automatización o técnicos en biotecnología que Chile forma pero que la economía no puede absorber porque las empresas que los necesitarían aún no existen.",
    sqm       = "Los $13.500 millones que SQM no tributó habrían financiado 338 empleos cualificados en I+D a través del programa Capital Humano para la Innovación de Corfo. Una empresa minera que extrae los recursos naturales de Chile destinó ese dinero a comprar influencia política en vez de contribuir a financiar la diversificación de la economía que le da sustento.",
    penta     = "Los $16.200 millones del Caso Penta habrían financiado 405 empleos cualificados en I+D a través del programa Capital Humano para la Innovación de Corfo —profesionales y técnicos contratados por empresas para desarrollar proyectos de innovación. Son puestos de trabajo para las personas que Chile invierte en formar y que luego emigran o trabajan en empleos que no requieren su formación.",
    milicogate = "Los $10.657 millones desviados de los fondos del Ejército habrían financiado 266 empleos cualificados en I+D a través del programa Capital Humano para la Innovación de Corfo. Doscientos sesenta y seis puestos de trabajo en innovación y desarrollo tecnológico: eso es lo que el Milicogate le costó a la economía que Chile intenta construir."
  ),
...
server <- function(input, output, session) {
  ...
  output$subareas_dinamicas <- renderUI({
    ...
    bloques <- lapply(1:nrow(df), function(i) {
      ...
      div(class = "subarea-bloque",
        ...
        plotlyOutput(paste0("grafico_", sid), height = "180px"),
  ...
  # Helper: format a number with K/M suffix
  fmt_num <- function(x) {
    dplyr::case_when(
      x >= 1e6 ~ paste0(format(round(x / 1e6, 1), big.mark = "."), "M"),
      x >= 1e3 ~ format(round(x), big.mark = "."),
      TRUE      ~ format(round(x, 1), big.mark = ".")
    )
  }

  # Helper: shorten case names
  nombre_corto <- function(n) {
    dplyr::case_when(
      n == "Corfo-Inverlink" ~ "Inverlink",
      n == "Pacogate"        ~ "Pacogate",
      n == "Caso SQM"        ~ "SQM",
      n == "Caso Penta"      ~ "Penta",
      n == "Milicogate"      ~ "Milicogate",
      TRUE ~ n
    )
  }

  # Generate charts for each subarea
  observe({
    area_sel   <- input$area_sel
    caso_id    <- input$caso_sel
    ...
    # Pre-compute all 5-case equivalences
    df_5casos <- tidyr::crossing(
      tabla_casos %>% select(id, nombre, monto_mm),
      df_subareas %>% select(subarea_id, costo_unitario_mm, unidad)
    ) %>% mutate(equiv = monto_mm / costo_unitario_mm)
    ...
    lapply(seq_len(nrow(df_subareas)), function(i) {
      ...
      local({
        ...
        escala_local   <- row$escala_mm        # NA or numeric MM
        escala_lbl     <- row$escala_label     # NA or string

        equiv_caso <- monto_sel / row$costo_unitario_mm

        output[[paste0("grafico_", sid_local)]] <- renderPlotly({

          # --- CHART TYPE A: caso vs. total del problema (2 bars) ---
          if (!is.na(escala_local)) {
            escala_equiv <- escala_local / row$costo_unitario_mm

            df_2 <- tibble::tibble(
              etiqueta = c(
                nombre_corto(tabla_casos$nombre[tabla_casos$id == caso_id]),
                "Escala total del problema"
              ),
              valor  = c(equiv_caso, escala_equiv),
              color  = c(color_area, "#E8E4D0"),
              lbl    = c(fmt_num(equiv_caso), fmt_num(escala_equiv)),
              hover  = c(
                paste0(tabla_casos$nombre[tabla_casos$id == caso_id], ": ",
                       fmt_num(equiv_caso), " ", unidad_local),
                paste0(escala_lbl, ": ", fmt_num(escala_equiv), " ", unidad_local)
              )
            )
            ...
            plot_ly(
              ...
              layout(
                xaxis = list(visible = FALSE, showgrid = FALSE, zeroline = FALSE,
                             range = c(0, max(df_2$valor, na.rm = TRUE) * 1.40)),
                yaxis = list(showgrid = FALSE, zeroline = FALSE, autorange = "reversed",
                             tickfont = list(family = "Spectral", color = "#4B3621", size = 12)),
                margin        = list(l = 160, r = 70, t = 10, b = 10),
                paper_bgcolor = "rgba(0,0,0,0)",
                plot_bgcolor  = "rgba(0,0,0,0)",
                bargap        = 0.45,
                font          = list(family = "Spectral", color = "#4B3621", size = 12),
                showlegend    = FALSE
              ) %>%
              config(displayModeBar = FALSE)

          # --- CHART TYPE B: 5 casos comparados (when no total scale available) ---
          } else {
            df_plot <- df_5casos %>%
              filter(subarea_id == sid_local) %>%
              mutate(
                color_barra  = ifelse(id == caso_id, color_area, "#D9D4C5"),
                nombre_short = nombre_corto(nombre),
                lbl          = fmt_num(equiv),
                hover_txt    = paste0(nombre, ": ", fmt_num(equiv), " ", unidad_local)
              ) %>%
              arrange(equiv)
            ...
            plot_ly(
              ...
              layout(
                xaxis = list(visible = FALSE, showgrid = FALSE, zeroline = FALSE,
                             range = c(0, max(df_plot$equiv) * 1.35)),
                yaxis = list(showgrid = FALSE, zeroline = FALSE,
                             tickfont = list(family = "Spectral", color = "#4B3621", size = 12)),
                margin        = list(l = 70, r = 60, t = 8, b = 8),
                paper_bgcolor = "rgba(0,0,0,0)",
                plot_bgcolor  = "rgba(0,0,0,0)",
                bargap        = 0.35,
                font          = list(family = "Spectral", color = "#4B3621", size = 12),
