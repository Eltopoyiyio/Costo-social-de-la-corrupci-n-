...
red_nodos <- tibble::tribble(
  ...
  "delano",      "Carlos\nDelano",      "penta",        "Controlador del Grupo Penta. Principal organizador del sistema de boletas falsas para financiamiento politico ilegal.",                                                                                                                   "Amigo personal declarado de Sebastian Pinera. Dueno del 85% de la minera Dominga via Andes Iron. Contrato a Pablo Wagner como asesor mientras era subsecretario de Mineria.",                                                                                                 "Condenado 2018: 4 anos libertad vigilada + multa $857 MM. Condena cumplida julio 2022 tras curso de etica en la UAI.",
  "lavin",       "Carlos\nLavin",       "penta",        "Controlador del Grupo Penta junto a Delano. Coorganizador del sistema de financiamiento ilegal.",                                                                                                                                          "Socio directo de Delano en el holding financiero que financiaba campanas de la UDI.",                                                                                                                                                                                         "Condenado 2018: 4 anos libertad vigilada + multa $857 MM. Condena cumplida julio 2022.",
  "bravo",       "Hugo\nBravo (+)",     "penta",        "Exgerente general de Penta. Delato a sus superiores ante la Fiscalia, revelando los pagos a politicos UDI. Fue el principal informante del fiscal Gajardo.",                                                                               "Su declaracion ante el fiscal Gajardo fue el hito que destapo el entramado politico del caso.",                                                                                                                                                                               "Fallecio en 2017 antes del juicio abreviado.",
  ...
  "carvajal",    "Orlando\nCarvajal",   "penta",        "Contador del grupo. Primera condena del caso (antes que Novoa): 5 anos libertad vigilada por fraude tributario y soborno.",                                                                                                               "Primer condenado del Caso Penta. Ejecutor contable en los escalones medios del sistema.",                                                                                                                                                                                     "5 anos libertad vigilada.",
  "alvarez",     "Ivan\nAlvarez",       "penta",        "Exfuncionario del SII. Reconocio cargos de delitos tributarios, cohecho y lavado de activos.",                                                                                                                                            "Punto de contacto entre el grupo empresarial y el Servicio de Impuestos Internos. Su participacion ilustra como el sistema de corrupcion penetraba en los organismos fiscalizadores.",                                                                                        "Condenado a 5 anos de libertad vigilada intensiva.",
  "ponce",       "Julio\nPonce Lerou",  "sqm",          "Controlador y presidente de SQM. Yerno del dictador Augusto Pinochet. Beneficiario directo del sistema que financiaba la politica para proteger sus intereses empresariales.",                                                             "Obtuvo el control de SQM durante la dictadura de Pinochet, a traves de una privatizacion cuestionada. Esa red de relaciones fue el origen del poder que luego uso para corromper el sistema democratico.",                                                                    "Sin formalizacion en la causa principal. Renuncio a la presidencia de SQM en 2015.",
  "contesse",    "Patricio\nContesse",  "sqm",          "Exgerente general de SQM por 25 anos. Ejecutor directo del 97% de los pagos ilegales a politicos.",                                                                                                                                       "Declaro en 2018 que estimo necesario apoyar la actividad politica bajo cierto marco que iba mas alla del Servel. Fue el operador ejecutivo del sistema de corrupcion.",                                                                                                        "Absuelto en octubre de 2025. Desvinculado de SQM.",
  "cruzat",      "Manuel\nCruzat",      "empresarial",  "Empresario. Mentor de Delano, Lavin y Bravo, a quienes hizo clases en la UC, recluto para sus empresas y de quienes luego fue competidor.",                                                                                               "Involucrado en contratos forward con Penta. Declaro ante la Fiscalia. Su figura ilustra los lazos entre las elites economicas que anteceden a los casos.",                                                                                                                    "Declaro ante la Fiscalia. Sin condena en las causas vinculadas a Penta.",
  "pinera",      "Sebastian\nPinera",   "empresarial",  "Expresidente de Chile (2010-2014 y 2018-2022). Amigo personal declarado de Carlos Delano. Fallecio en febrero de 2024.",                                                                                                                  "Los chats de Guerra y Hermosilla lo mencionan en relacion a Dominga y Penta. Una sociedad suya tenia un contrato forward con Penta desde 2009. Fue quien convoco a Pablo Wagner como subsecretario de Mineria. Tambien llamo a Jorge Abbott al cargo de Fiscal Nacional.",    "Nunca formalizado. Fallecio el 6 de febrero de 2024.",
  ...
  "wagner",      "Pablo\nWagner",       "chilevamos",   "Exsubsecretario de Mineria del primer gobierno de Pinera (2010-2012). Recibio $66 MM de Penta mientras ejercia el cargo. Nodo central de la conexion Penta-SQM-Dominga.",                                                                 "Recibio pagos de Penta mientras era subsecretario. Identificado por el DOJ de EE.UU. como funcionario chileno 3 en el caso SQM. Mientras estaba en el cargo, asesoro a la familia Delano sobre como presentar el proyecto minero Dominga al Ministerio de Mineria.",          "Condenado caso Penta 2018: 2 anos pena remitida + 3 anos inhabilitacion cargos publicos. Absuelto caso SQM octubre 2025.",
  ...
  "larrainH",    "Hernan\nLarrain",     "chilevamos",   "Exsenador UDI. Luego ministro de Justicia del segundo gobierno de Pinera. Organizo la reunion secreta con Abbott en la oficina de Zumelzu para negociar el juicio abreviado de Novoa. Posteriormente pidio a Abbott que resolviera el caso de Moreira.", "Nodo clave entre el partido, los imputados y el Fiscal Nacional. Su rol muestra como la negociacion politica sobre causas judiciales activas operaba en privado.",                                                                                                          "Sin condena. Los hechos estan documentados en los chats del Caso Audios (Hermosilla-Guerra).",
  "zumelzu",     "Mario\nZumelzu",      "chilevamos",   "Abogado de la UDI. Su oficina fue el lugar de la reunion secreta entre Abbott y Larrain donde se negocio el juicio abreviado de Novoa.",                                                                                                   "Facilitador logistico de la reunion clave entre el poder politico y el poder judicial. Su oficina fue el espacio fisico donde se gestiono una causa activa en privado.",                                                                                                       "Sin condena.",
  "chadwick",    "Andres\nChadwick",    "chilevamos",   "Exministro del Interior del segundo gobierno de Pinera. Amigo intimo y socio de Luis Hermosilla.",                                                                                                                                        "Recibio transferencias de Hermosilla por $229 millones tras dejar el cargo de ministro. Los chats de Guerra lo mencionan como contacto clave para gestionar salidas en el Caso Penta. Punto de contacto entre el gobierno de Pinera, el partido y la red judicial de Hermosilla.", "Sin condena en causas vinculadas a Penta. Imputado en el Caso Audios.",
  ...
  "penailillo",  "Rodrigo\nPenailillo", "nuevamayoria", "Exministro del Interior del segundo gobierno de Bachelet. Encabezo las presiones sobre el SII para frenar la investigacion del Caso SQM en 2015.",                                                                                        "Emitio boletas a la empresa de Martelli (AyN) que recibia fondos de SQM. Fue el quien coordino las gestiones para que el SII no presentara querella contra los involucrados. Su caso ilustra que la corrupcion no tiene color politico.",                                      "No perseverado en 2021. Sin condena.",
...
server <- function(input, output, session) {
  ...
  output$red_poder <- renderVisNetwork({
    ...
    # Funcion auxiliar para oscurecer un color hex
    darken_hex <- function(hex, amount = 0.25) {
      rgb_vals <- col2rgb(hex) / 255
      rgb_dark  <- pmax(rgb_vals - amount, 0)
      rgb(rgb_dark[1], rgb_dark[2], rgb_dark[3])
    }

    nodos_vis <- red_nodos %>%
      mutate(
        color.background = red_colores[grupo],
        color.border     = mapply(darken_hex, red_colores[grupo]),
        color.highlight.background = mapply(darken_hex, red_colores[grupo], MoreArgs = list(amount = 0.15)),
        font.color = "#FFFFFF",
        font.size  = 13,
        font.face  = "bold",
        size       = 28,
        title      = paste0(
          "<div style='max-width:220px; font-family:Spectral,serif; font-size:0.82rem; padding:6px;'>",
          "<strong style='font-size:0.95rem;'>", gsub("\n", " ", label), "</strong><br/>",
          "<span style='color:", color.background, "; font-size:0.75rem;'>",
          red_grupos_label[grupo], "</span><hr style='margin:6px 0;'/>",
          "<strong>Rol:</strong> ", rol, "<br/><br/>",
          "<strong>Conexiones:</strong> ", conexion, "<br/><br/>",
          "<em style='color:#8B4513;'>", estado, "</em>",
          "</div>"
        )
      ) %>%
      select(id, label, color.background, color.border, color.highlight.background,
             font.color, font.size, font.face, size, title)

    aristas_vis <- red_aristas %>%
      mutate(
        color  = "#C8B8A0",
        width  = 1.5,
        arrows = "to",
    ...
    visNetwork(nodos_vis, aristas_vis,
      ...
      visEdges(
        color = list(color = "#C8B8A0", highlight = "#8B4513", hover = "#8B4513"),
        smooth = list(enabled = TRUE, type = "continuous"),
        width = 1.5
      ) %>%
      visOptions(
      ...
      visEvents(
        ...
        deselectNode = "function(nodes) {
          Shiny.setInputValue('nodo_seleccionado', null, {priority: 'event'});
        }"
      )
  })
