...
ui <- page_fluid(
  ...
  div(class = "container-main",
    ...
    accordion(
      ...
      accordion_panel(
        ...
        p(style = "color:#6a5a45; margin-bottom:24px;",
          "Si hay algo que los chilenos recordamos muy bien, es que Chile tiene mala memoria. Esta sección esta creada para subsanar un poco ese problema.",
      ...
      accordion_panel(
        ...
        div(style = "margin-top:32px; border-top:1px solid #E5E4D0; padding-top:24px;",
          p(style = "color:#4B3621; line-height:1.8; font-style:italic;",
            "Lo que muestra esta red no es una conspiración con jerarquías claras ni un plan maestro urdido en la oscuridad. Es el resultado de décadas de proximidad entre élites que se conocen, se deben favores, comparten intereses y comparten la convicción implícita de que las reglas que aplican a los demás no aplican necesariamente a ellos. El Caso Audios —que llegó en 2023 con audios grabados en secreto y chats filtrados— demostró que la red seguía operando, con colectividades y personajes ya conocidos de los casos Penta y SQM. De manera involuntaria, la red aquí graficada permite observar de manera ilustrativa como las relaciones que han perpetuado este tipo de crimen pueden rastrearse desde la última dictadura hasta la actualidad."
          )
        )
      )
    ),
    ...
    # --- CONCLUSIÓN ---
    h2("¿Cuánto nos cuesta no hacer nada?", class = "section-title"),
    div(id = "conclusion",
      p("El objetivo declarado y principal de este proyecto es el de poder visualizar el daño tangible que generan los casos de corrupción, mediante escenarios hipotéticos. En la primera parte de esta aplicación se ha logrado con creces ese objetivo. No solo se ha demostrado cómo cada peso defraudado pudo haber aportado a solucionar la problematica en treinta casos distintos, sino que, de manera involuntaria, se ha demostrado la magnitud de una de las principales crisis de nuestro tiempo. El hecho de que todos los casos de corrupción representen una fracción mínima de la crisis habitacional, es una señal que, por lo bajo, debe despertar más alarmas y, ojalá, entregar soluciones más totales."),
      p("Hablar de los daños económicos provocados por la corrupción, y no hablar de sus protagonistas puede llegar a ser irresponsable. Más aún considerando el clima político actual que vive el país. En la última encuesta CEP (septiembre - octubre 2025), el 29% de los encuestados afirmaba que el autoritarismo es preferible en algunas circunstancias. Si bien no se puede afirmar que la corrupción es el único factor que explica estas preferencias, si es un pilar fundamental para explicar el desencanto con el sistema democrático. Mal que mal ¿Por qué tendría yo que votar a un político, si son todos corruptos?¿No sería mejor que una sola persona, o un grupo de expertos, fueran capaces de decidir, aplicar mano dura y mandar a todos estos ladrones a la cárcel? Probablemente ha escuchado ese tipo de comentarios con más frecuencia los últimos años. Las últimas dos secciones de esta aplicación nos pueden ayudar a generar respuestas a esas preguntas a favor de la democracia."),
      p("Primeramente cabe aclarar, como quedó especificado en la sección ´Para los chismosos´, que en 3/5 de los casos analizados, la mayoría de los principales involucrados en estos casos de corrupción no son políticos, no declaran una preferencia política. Los involucrados son un su mayoría empresarios, gerentes de grandes empresas, contadores, oficiales y funcionarios públicos. No son todos políticos, pero hay algo que todos tienen en común: son poderosos. ¿Se imagina usted toda la cantidad de cosas que podríamos no saber si es que dejásemos que se socave la democracia, y solo unos pocos poderosos tomaran todas las decisiones? Este proyecto, sin planificarlo pero por un sentido de responsabilidad ciudadana, se propone también como una defensa de la democracia. No porque la democracia sea perfecta —estos casos ocurrieron en democracia, y en varios de ellos la impunidad fue también un producto del sistema democrático. Sino porque la democracia es el único sistema que permite nombrar lo que pasó, investigarlo, documentarlo y exigir que no vuelva a ocurrir. Solo en democracia, y con una participación y exigencia ciudadanas activas, se puede echar luz sobre los actos de los Hermosillas, Délanos y Monasterios que existen aún en nuestro país y abogar porque se les juzgue como es debido. El dicho dice que piedad para el culpable es traición para el inocente. No actuar porque nuestros recursos no vayan a parar a manos de unos pocos poderosos, es ser complice de la miseria a la que se deben someter miles de personas a las que ese dinero no llegó")
    ),
