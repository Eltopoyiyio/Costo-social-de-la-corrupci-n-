    ...
    accordion(
      ...
      accordion_panel(
        ...
        div(style = "display:flex; flex-wrap:wrap; gap:12px; margin-bottom:16px; align-items:center;",
          ...
          tags$span(style = "background:#D43B3B; color:white; padding:3px 10px; border-radius:12px; font-size:0.78rem;", "Nueva Mayoria"),
          ...
          tags$span(style = "background:#B8860B; color:white; padding:3px 10px; border-radius:12px; font-size:0.78rem;", "Contexto historico")
        ),
        p(style = "font-size:0.78rem; color:#aaa; margin-bottom:18px;",
          "Haz clic en un nodo para ver informacion del personaje. Puedes arrastrar los nodos para reorganizar la red. Las conexiones muestran hechos documentados periodistica o judicialmente. No todas implican condena ni responsabilidad penal."
        ),
...
red_nodos <- tibble::tribble(
  ...
  # ── PENTA ───────────────────────────────────────────────────────────────────
  "delano",        "Carlos\nDelano",         "penta",         "Controlador del Grupo Penta. Principal organizador del sistema de boletas falsas para financiamiento politico ilegal. Dueno del 85% de Andes Iron, titular del proyecto minero Dominga.",                                                          "Amigo personal declarado de Sebastian Pinera. Contrato a Pablo Wagner como asesor de Dominga mientras era subsecretario de Mineria. La familia Delano le pidio a Wagner que los ayudara a presentar el proyecto ante el Ministerio de Mineria.",                                                           "Condenado 2018: 4 anos libertad vigilada + multa $857 MM. Condena cumplida julio 2022 tras curso de etica en la UAI.",
  "lavin",         "Carlos\nLavin",          "penta",         "Controlador del Grupo Penta junto a Delano. Coorganizador del sistema de financiamiento politico ilegal.",                                                                                                                                         "Socio directo de Delano en el holding financiero. Junto a Delano financiaron campanas principalmente de la UDI a traves de boletas ideologicamente falsas.",                                                                                                                                               "Condenado 2018: 4 anos libertad vigilada + multa $857 MM. Condena cumplida julio 2022.",
  "bravo",         "Hugo\nBravo (+)",        "penta",         "Exgerente general de Penta. Delato a sus superiores ante la Fiscalia, revelando los pagos a politicos UDI. Principal informante del fiscal Gajardo.",                                                                                              "Su declaracion ante la Fiscalia fue el hito que destapo el entramado politico completo del caso.",                                                                                                                                                                                                        "Fallecio en 2017 antes del juicio abreviado.",
  "castro",        "Marcos\nCastro",         "penta",         "Exgerente de Penta. Ejecutor contable del sistema de boletas falsas.",                                                                                                                                                                             "Ejecutor directo del sistema de facturas ideologicamente falsas que financiaban la politica.",                                                                                                                                                                                                             "Condena en procedimiento abreviado.",
  "carvajal",      "Orlando\nCarvajal",      "penta",         "Contador del grupo. Primera condena del caso: 5 anos libertad vigilada por fraude tributario y soborno.",                                                                                                                                          "Primer condenado del Caso Penta, antes incluso que Novoa. Ejecutor contable en los escalones medios del sistema.",                                                                                                                                                                                        "5 anos libertad vigilada.",
  "alvarez",       "Ivan\nAlvarez",          "penta",         "Exfuncionario del SII. Reconocio cargos de delitos tributarios, cohecho y lavado de activos.",                                                                                                                                                     "Punto de contacto entre el grupo empresarial y el Servicio de Impuestos Internos. Su participacion ilustra como el sistema de corrupcion penetraba en los organismos fiscalizadores del Estado.",                                                                                                         "Condenado a 5 anos de libertad vigilada intensiva.",

  # ── SQM ─────────────────────────────────────────────────────────────────────
  "ponce",         "Julio\nPonce Lerou",     "sqm",           "Controlador y presidente de SQM. Yerno del dictador Augusto Pinochet. Obtuvo el control de SQM durante la dictadura a traves de privatizaciones cuestionadas y del Caso Cascadas.",                                                               "El Caso Cascadas (2013) revelo que Ponce Lerou uso sociedades instrumentales para manipular el precio de las acciones de SQM en bolsa, transfiriendo riqueza desde los accionistas minoritarios (incluidos trabajadores de la empresa) hacia si mismo. Ese esquema le permitio consolidar su control sobre SQM y acumular el poder que luego uso para financiar ilegalmente la politica.",  "Sin formalizacion en la causa principal de SQM. Multado por la CMF en el Caso Cascadas. Renuncio a la presidencia de SQM en 2015.",
  "contesse",      "Patricio\nContesse",     "sqm",           "Exgerente general de SQM por 25 anos. Ejecutor directo del 97% de los pagos ilegales a politicos.",                                                                                                                                                "Declaro en 2018 que estimo necesario apoyar la actividad politica bajo cierto marco que iba mas alla del Servel. Fue el operador ejecutivo del sistema que distribuia los fondos a todo el espectro politico.",                                                                                            "Absuelto en octubre de 2025. Desvinculado de SQM.",

  # ── ENTORNO EMPRESARIAL ──────────────────────────────────────────────────────
  "cruzat",        "Manuel\nCruzat",         "empresarial",   "Empresario. Mentor de Delano, Lavin y Bravo, a quienes hizo clases en la UC, recluto para sus empresas y de quienes luego fue competidor.",                                                                                                        "Involucrado en contratos forward con Penta. Declaro ante la Fiscalia. Su figura ilustra los lazos entre las elites economicas que anteceden y moldean a los protagonistas de los casos.",                                                                                                                  "Declaro ante la Fiscalia. Sin condena en las causas vinculadas a Penta.",
  "pinera",        "Sebastian\nPinera (+)",  "empresarial",   "Expresidente de Chile (2010-2014 y 2018-2022). Amigo personal declarado de Carlos Delano. Fallecio en febrero de 2024.",                                                                                                                           "Los chats de Guerra y Hermosilla lo mencionan en relacion a Dominga y Penta. Una sociedad suya tenia un contrato forward con Penta desde 2009. Convoco a Pablo Wagner como subsecretario de Mineria. Llamo a Jorge Abbott al cargo de Fiscal Nacional.",                                                   "Nunca formalizado. Fallecio el 6 de febrero de 2024.",
  "dominga",       "Proyecto\nDominga",      "empresarial",   "Proyecto minero de la familia Delano (Andes Iron), ubicado en la Region de Coquimbo. Requeria aprobacion ambiental del Estado.",                                                                                                                   "Pablo Wagner, mientras era subsecretario de Mineria pagado con fondos de Penta, asesoro a la familia Delano sobre como presentar el proyecto Dominga ante el Ministerio de Mineria. El proyecto fue aprobado en primera instancia en 2017 y rechazado en segunda. Los chats del Caso Audios mencionan a Pinera en relacion con el proyecto.",                                                               "Proyecto sin aprobacion ambiental definitiva. Conexion documentada en el Caso Audios.",

  # ── CHILE VAMOS ─────────────────────────────────────────────────────────────
  "novoa",         "Jovino\nNovoa",          "chilevamos",    "Exsenador y expresidente de la UDI. Decidia a que candidatos del partido asignar los fondos de Penta. Facilito 17 boletas falsas entre 2008 y 2013.",                                                                                              "Figura historica del gremialismo y ex secretario general del gobierno de Pinochet. Su condena en Penta fue negociada en reunion secreta entre Abbott, Larrain y Zumelzu.",                                                                                                                                "Condenado Caso Penta: 3 anos presidio menor pena remitida + multa $7,6 MM. Firmo mensualmente en CRS de Nunoa. Condena cumplida marzo 2019.",
  "wagner",        "Pablo\nWagner",          "chilevamos",    "Exsubsecretario de Mineria del primer gobierno de Pinera (2010-2012). Recibio $66 MM de Penta mientras ejercia el cargo. Nodo central de la conexion Penta-SQM-Dominga.",                                                                          "Recibio pagos de Penta mientras era subsecretario. Identificado por el DOJ de EE.UU. como funcionario chileno 3 en el caso SQM. Asesoro a la familia Delano sobre como presentar el proyecto minero Dominga al Ministerio que el mismo encabezaba.",                                                      "Condenado caso Penta 2018: 2 anos pena remitida + 3 anos inhabilitacion cargos publicos. Absuelto caso SQM octubre 2025.",
  "moreira",       "Ivan\nMoreira",          "chilevamos",    "Senador UDI. Solicito financiamiento a Penta por correo para su campana senatorial de 2013 ($35 MM en boletas falsas).",                                                                                                                           "Su salida del caso fue negociada directamente: Abbott instruyo a Guerra para resolver su situacion procesal favorablemente, en el marco de los contactos con Larrain.",                                                                                                                                    "Sobreseido febrero 2019 tras suspension condicional + multa $35 MM.",
  "golborne",      "Laurence\nGolborne",     "chilevamos",    "Exministro de Obras Publicas y ex precandidato presidencial UDI. Penta financio su campana presidencial.",                                                                                                                                         "Ex ministro de Pinera y figura visible del partido. Su candidatura presidencial fue uno de los destinos del financiamiento ilegal de Penta.",                                                                                                                                                              "Suspension condicional (sept. 2019) + pago $11,4 MM. Sobreseido al ano.",
  "demussy",       "Felipe\nDe Mussy",       "chilevamos",    "Diputado UDI. Imputado por financiamiento irregular proveniente de Penta.",                                                                                                                                                                        "Parte del grupo de politicos UDI que recibian financiamiento del holding de Delano y Lavin.",                                                                                                                                                                                                              "Salida alternativa. Sobreseido.",
  ...
  "cardemil",      "Alberto\nCardemil",      "chilevamos",    "Exdiputado RN. Penta habria financiado su campana a traves de dos abogados como intermediarios.",                                                                                                                                                   "Receptor de financiamiento de Penta canalizado a traves de intermediarios, lo que muestra que la red no se limitaba a la UDI.",                                                                                                                                                                            "Salida alternativa.",
  "vonbaer",       "Ena Von\nBaer",          "chilevamos",    "Senadora UDI. Mencionada en correos del caso como beneficiaria de financiamiento de Penta.",                                                                                                                                                        "Su nombre aparece en la correspondencia interna de Penta como destinataria de financiamiento. Citada a declarar.",                                                                                                                                                                                        "Sin formalizacion. Nego irregularidades.",
  "esilva",        "Ernesto\nSilva",         "chilevamos",    "Extimonel de la UDI. Su partido fue el principal receptor del financiamiento ilegal de Penta.",                                                                                                                                                     "Presidio la UDI en el periodo en que el financiamiento de Penta era un mecanismo normalizado dentro del partido.",                                                                                                                                                                                        "Renuncio a la directiva en marzo 2015. Sin formalizacion.",
  "larrainH",      "Hernan\nLarrain",        "chilevamos",    "Exsenador UDI. Ministro de Justicia del segundo gobierno de Pinera. Organizo la reunion secreta con Abbott en la oficina de Zumelzu para negociar el juicio abreviado de Novoa. Posteriormente pidio a Abbott resolver el caso de Moreira.",       "Nodo clave entre el partido, los imputados y el Fiscal Nacional. Su rol muestra como la negociacion politica sobre causas judiciales activas operaba en privado, fuera de cualquier control institucional.",                                                                                             "Sin condena. Los hechos estan documentados en los chats del Caso Audios (Hermosilla-Guerra).",
  "zumelzu",       "Mario\nZumelzu",         "chilevamos",    "Abogado UDI. Su oficina fue el lugar de la reunion secreta entre Abbott y Larrain donde se negocio el juicio abreviado de Novoa.",                                                                                                                  "Facilitador logistico de la reunion clave entre el poder politico y el poder judicial. Su oficina fue el espacio fisico donde se gestiono una causa activa en privado.",                                                                                                                                   "Sin condena.",
  ...
  # ── NUEVA MAYORÍA ────────────────────────────────────────────────────────────
  "penailillo",    "Rodrigo\nPenailillo",    "nuevamayoria",  "Exministro del Interior del segundo gobierno de Bachelet. Encabezo las presiones sobre el SII para frenar la investigacion del Caso SQM en 2015.",                                                                                                 "Emitio boletas a la empresa de Martelli (AyN) que recibia fondos de SQM. Coordino las gestiones para que el SII no presentara querella contra los involucrados. Su caso ilustra que la corrupcion no tiene color politico.",                                                                               "No perseverado en 2021. Sin condena.",
  "martelli",      "Giorgio\nMartelli",      "nuevamayoria",  "Recaudador y operador politico de la Concertacion. Su empresa AyN recibio $338 millones de SQM para financiar la precampana de Bachelet.",                                                                                                         "Principal canal de financiamiento de SQM hacia la Nueva Mayoria. Fue el eslabon entre la empresa minera y los partidos de centroizquierda.",                                                                                                                                                               "Formalizado. Condenado: 800 dias pena cumplida en libertad + multa.",
  "donoso",        "Samuel\nDonoso",         "nuevamayoria",  "Abogado PPD. Asesor de Penailillo. Se presento en reunion en Hacienda para presionar al SII a no querellarse contra Martelli. Tambien represento a Contesse de SQM y obstaculizo la entrega de contabilidad a la Fiscalia.",                       "Opero en los dos flancos: como asesor politico de Penailillo y como abogado defensor de los principales ejecutivos de SQM. Un mismo profesional cubriendo intereses de la empresa y del gobierno que debia fiscalizarla.",                                                                                 "Sin condena.",
  ...
  "pizarro",       "Jorge\nPizarro",         "nuevamayoria",  "Exvicepresidente del Senado (DC). Sus hijos Jorge y Benjamin Pizarro Cristi escaparon del proceso por inaccion del SII.",                                                                                                                          "El SII no presento querella contra sus hijos, quienes aparecian como receptores indirectos de fondos de SQM. El senador Pizarro fue uno de los politicos cuyas familias se beneficiaron del esquema sin consecuencias judiciales.",                                                                        "Sin formalizacion. Sus hijos tampoco fueron formalizados.",
  "arenas",        "Alberto\nArenas",        "nuevamayoria",  "Exministro de Hacienda del segundo gobierno de Bachelet. Co-encabezo junto a Penailillo las presiones al SII en 2015 para frenar la investigacion SQM.",                                                                                           "Junto a Penailillo coordino las gestiones para que el SII no ampliara la querella en el Caso SQM. Es uno de los dos ministros del gobierno de Bachelet directamente documentados en el intento de frenar la investigacion.",                                                                               "Sin formalizacion.",
  ...
  "correa",        "Harold\nCorrea",         "nuevamayoria",  "PPD. Exjefe de gabinete del exministro Nicolas Eyzaguirre. El SII no presento querella en su contra.",                                                                                                                                             "Su caso ilustra como la proteccion politica dentro del gobierno de Bachelet alcanzo tambien a funcionarios de segundo rango que estaban vinculados a la red de financiamiento de SQM.",                                                                                                                   "Sin formalizacion. El SII no presento querella.",

  # ── INDEPENDIENTE ───────────────────────────────────────────────────────────
  "velasco",       "Andres\nVelasco",        "independiente", "Ex precandidato presidencial independiente. PDI allano su domicilio. Declaro ante la Fiscalia en el marco del Caso Penta.",                                                                                                                         "Un almuerzo pagado por Penta genero la investigacion. Su caso ilustra que el financiamiento ilegal alcanzaba a candidatos de todo el espectro, incluyendo figuras independientes de la izquierda liberal.",                                                                                                "Sin formalizacion. Declaro como testigo.",

  # ── RED JUDICIAL ────────────────────────────────────────────────────────────
  "abbott",        "Jorge\nAbbott",          "judicial",      "Exfiscal Nacional de Chile (2015-2023). Se reunio en secreto con Hernan Larrain y Mario Zumelzu mientras era candidato a fiscal, negociando salidas para imputados del Caso Penta. Instruyo internamente acotar las investigaciones de platas politicas.", "Centro neuralgico de la red judicial. Coordino con Larrain la salida de Novoa y la situacion de Moreira. Fue nombrado Fiscal Nacional en un proceso influenciado por sus relaciones con actores politicos del caso. Investigado en el Caso Audios.",                                                    "Sin condena. Dejo el cargo de Fiscal Nacional en 2023.",
  "guerra",        "Manuel\nGuerra",         "judicial",      "Exfiscal Regional Oriente. Manejo directamente las causas del Caso Penta. Los chats con Hermosilla muestran coordinacion para dar salidas favorables a imputados y solicitudes de empleo a cambio.",                                                "Coordinaba con Hermosilla las resoluciones en causas activas. Su caso es el eslabon mas explicito entre el poder judicial, el poder politico y el mundo empresarial. Actuaba como intermediario entre Abbott y los intereses de Penta.",                                                                    "En prision preventiva en Capitan Yabar. Formalizado por cohecho, prevaricacion administrativa y violacion de secreto. Caso Audios.",
  "hermosilla",    "Luis\nHermosilla",       "judicial",      "Abogado. Hub central de la red judicial. Sus chats con el fiscal Guerra muestran coordinacion para dar salidas favorables a causas de Penta.",                                                                                                      "Recibio $229 millones de Andres Chadwick, presuntamente como honorarios profesionales. Conecta el mundo empresarial (clientes como Delano), el mundo politico (Chadwick, ex ministro de Pinera) y el poder judicial (Guerra). Su red cruzaba todos los poderes del Estado.",                               "En prision preventiva. Formalizado en el Caso Audios por cohecho, obstruccion a la justicia y otros delitos.",
  "caso_audios",   "Caso\nAudios",           "judicial",      "Investigacion judicial iniciada en 2023 tras la filtracion de audios y chats de Luis Hermosilla que revelaron como operaba la red de influencias sobre el sistema judicial chileno.",                                                               "El Caso Audios es la continuacion natural de los casos Penta y SQM: muestra que las redes de influencia no desaparecieron con las condenas de 2018, sino que siguieron operando. Involucra directamente a Hermosilla, Guerra, Chadwick, Abbott y Larrain.",                                               "Investigacion activa. Multiples formalizados. Hermosilla y Guerra en prision preventiva.",

  # ── CONTEXTO HISTORICO ───────────────────────────────────────────────────────
  "pinochet",      "Augusto\nPinochet",      "contexto",      "Dictador de Chile (1973-1990). Suegro de Julio Ponce Lerou. La dictadura creo el marco legal e institucional que hizo posible que Ponce Lerou controlara SQM.",                                                                                     "Durante la dictadura, Ponce Lerou fue designado interventor y luego controlador de SQM a traves de privatizaciones cuestionadas. El poder acumulado gracias a esa relacion familiar con la dictadura fue el origen del esquema de financiamiento politico ilegal que destaparon los casos SQM y Cascadas.",  "Fallecido en diciembre de 2006. No hubo proceso judicial por su rol en la entrega de SQM a Ponce Lerou.",
  "cascadas",      "Caso\nCascadas",         "contexto",      "Caso judicial iniciado en 2013 por la CMF. Revelo que Julio Ponce Lerou uso sociedades instrumentales para manipular el precio de las acciones de SQM y transferir riqueza desde los accionistas minoritarios hacia si mismo.",                    "El Caso Cascadas es el origen financiero del poder de Ponce Lerou dentro de SQM: a traves de ese esquema consolido el control de la empresa a costa de los accionistas, incluidos trabajadores y fondos de pensiones. Ese poder fue el que luego uso para financiar ilegalmente la politica.",             "Sentenciado por la CMF. Ponce Lerou y otros ejecutivos multados. Sin prision efectiva."
)
    ...
    if (is.null(nodo_id) || nodo_id == "") {
      return(div(
        ...
        p(style = "color:#aaa; font-size:0.85rem; text-align:center;",
          "Haz clic en un nodo para ver informacion del personaje"
        )
      ))
    }
