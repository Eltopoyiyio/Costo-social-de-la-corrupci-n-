      ...
      accordion_panel(
        ...
        div(style = "margin-top:32px; border-top:1px solid #E5E4D0; padding-top:24px;",
          p(style = "color:#4B3621; line-height:1.8; font-style:italic;",
            "Lo que muestra esta red no es una conspiración con jerarquías claras ni un plan maestro urdido en la oscuridad. Es algo más difuso y por eso más resistente: el resultado de décadas de proximidad entre élites que se conocen, se deben favores y comparten la convicción implícita de que las reglas que aplican a los demás no aplican necesariamente a ellos. Esa convicción no murió con las condenas de 2018. El Caso Audios —que llegó en 2023 con audios grabados en secreto y chats filtrados— demostró que la red seguía operando. La diferencia es que esta vez quedó registrada en mensajes de WhatsApp."
          )
        )
      )
    ),
